...
<div class="kt-portlet kt-portlet--mobile">
      ...
      <div class="kt-portlet__head-toolbar">
        <div class="kt-portlet__head-wrapper">
          <div class="kt-portlet__head-actions">
            <?php echo $this->authuser->show_button('cms/Cms_news','C','',1)?>
            <?php echo $this->authuser->show_button('cms/Cms_news','D','',5)?>
            <?php echo $this->authuser->show_button('cms/Cms_news','EX','',1)?>
          </div>
        </div>
      </div>
    </div>
    <div class="kt-portlet__body">
      ...
      <!--begin: Datatable -->
      <table id="dynamic-table" base-url="<?php echo base_url()?>cms/Cms_news" class="table table-responsive-sm table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline">
        <thead>
