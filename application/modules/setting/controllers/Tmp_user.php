...
class Tmp_user extends MX_Controller {
    ...
    public function process()
    {
        ...
        $val->set_rules('flag_user', 'Jenis Pengguna', 'trim|xss_clean|required');
        ...
        {                       
            ...
            $dataexc = array(
                ...
                'flag_user' => ($val->set_value('flag_user') != '0') ? $this->regex->_genRegex($val->set_value('flag_user'),'RGXAZ') : NULL,
            );
            //print_r($dataexc);die;
            if($id==0){
        ...
        {                       
            ...
            if(isset($_FILES['images']['name'])){
                ...
                if( $id != 0 ){
                    ...
                    if (file_exists(PATH_PHOTO_PROFILE_DEFAULT.$profile->path_foto)) {
