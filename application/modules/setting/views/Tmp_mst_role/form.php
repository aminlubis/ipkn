    ...
    $('#form_Tmp_mst_role').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('<?php echo base_url()?>setting/Tmp_mst_role?_=' + (new Date()).getTime());
        }else{
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="kt-portlet">
      ...
      <!--begin::Form-->
      <form class="kt-form kt-form--label-right" method="post" id="form_Tmp_mst_role" action="<?php echo site_url('setting/Tmp_mst_role/process')?>" enctype="multipart/form-data">
        <br>
