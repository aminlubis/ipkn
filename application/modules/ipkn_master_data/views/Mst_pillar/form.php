...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="kt-portlet">
      ...
      <!--begin::Form-->
      <form class="kt-form kt-form--label-right" method="post" id="form_Mst_pillar" action="<?php echo site_url('ipkn_master_data/Mst_pillar/process')?>" enctype="multipart/form-data">
        <br>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8">
            <?php echo $this->master->custom_selection($params = array('table' => 'ipkn_mst_subindex', 'id' => 'index_id', 'name' => 'index_desc', 'where' => array('is_active' => 'Y') ), isset($value)?$value->index_id:'' , 'index_id', 'index_id', 'form-control', '', '') ?>
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="kt-portlet__foot">
          <div class="kt-form__actions">
            <div class="row">
              ...
              <div class="col-10">
              <a onclick="getMenu('ipkn_master_data/Mst_pillar')" href="#" class="btn btn-sm btn-success">
