    ...
    public function get_data()
    {
        ...
        foreach ($list as $row_list) {
            ...
            $row[] = '<div style="text-align: center">
                            ...
                            <input type="checkbox" name="selected_id[]" value="'.$row_list->function_id.'" class="kt-checkable">
                            <span></span>
                            </label>
                      </div>';
            $row[] = '<div style="text-align: center">
            ...
            $row[] = '<div style="text-align: center">'.$row_list->function_id.'</div>';
            $row[] = '<div style="text-align: center">'.strtoupper($row_list->code).'</div>';
