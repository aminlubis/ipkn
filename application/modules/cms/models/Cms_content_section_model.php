...
class Cms_content_section_model extends CI_Model {
	...
	private function _main_query(){
		...
		$this->db->where($this->table.".section_id", $_GET['section']);
	...
	public function get_by_id($id)
	{
		$this->_main_query();
		if(is_array($id)){
			$this->db->where_in(''.$this->table.'.content_id',$id);
			$query = $this->db->get();
			return $query->result();
		}else{
			$this->db->where(''.$this->table.'.content_id',$id);
			$query = $this->db->get();
			return $query->row();
		}
