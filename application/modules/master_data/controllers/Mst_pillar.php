...
class Mst_pillar extends MX_Controller {
    ...
    function __construct() {
        ...
        parent::__construct();
        /*breadcrumb default*/
        $this->breadcrumbs->push('Index', 'master_data/Mst_pillar');
    ...
    public function get_data()
    {
        ...
        foreach ($list as $row_list) {
            ...
            $row[] = '<div style="text-align: center">
                        '.$this->authuser->show_button('master_data/Mst_pillar','R',$row_list->pillar_id,2).'
                        '.$this->authuser->show_button('master_data/Mst_pillar','U',$row_list->pillar_id,2).'
                        '.$this->authuser->show_button('master_data/Mst_pillar','D',$row_list->pillar_id,2).'
                      </div>'; 
            // $row[] = '<div style="text-align: center">'.$row_list->pillar_id.'</div>';
            if($row_list->pillar_icon != NULL){
                $row[] = '<img src="'.base_url().'uploaded/images/'.$row_list->pillar_icon.'" width="50px">';
            }else{
                $row[] = '<div class="center">-No Image-</div>';
            }
