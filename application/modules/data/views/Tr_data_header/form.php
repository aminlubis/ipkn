    ...
    $('#form_Tr_data_header').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('<?php echo base_url()?>data/Tr_data_header?_=' + (new Date()).getTime());
        }else{
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="kt-portlet">
      ...
      <!--begin::Form-->
      <form class="kt-form kt-form--label-right" method="post" id="form_Tr_data_header" action="<?php echo site_url('data/Tr_data_header/process')?>" enctype="multipart/form-data">
        <br>
