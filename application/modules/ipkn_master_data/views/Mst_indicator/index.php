      ...
      <div class="kt-portlet__head-toolbar">
        <div class="kt-portlet__head-wrapper">
          <div class="kt-portlet__head-actions">
            <?php echo $this->authuser->show_button('ipkn_master_data/Mst_indicator','C','',1)?>
            <?php echo $this->authuser->show_button('ipkn_master_data/Mst_indicator','D','',5)?>
            <?php echo $this->authuser->show_button('ipkn_master_data/Mst_indicator','EX','',1)?>
          </div>
        </div>
      </div>
    </div>
    <div class="kt-portlet__body">
      ...
      <thead>
        <tr class="table-bg-blue">  
          ...
          <th style="color: white" width="50px">Kode</th>
          <th style="color: white">Indikator</th>
          <th style="color: white">Satuan</th>
          <th style="color: white">Deskripsi</th>
          <th style="color: white">Owner Data</th>
          <!-- <th style="color: white">Sumber Data</th> -->
        </tr>
      </thead>
      <tbody>
      </tbody>
