    ...
    $('#form_Mst_province').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('<?php echo base_url()?>ipkn_master_data/Mst_province?_=' + (new Date()).getTime());
        }else{
          $.achtung({message: jsonResponse.message, timeout:5});
        }
        achtungHideLoader();
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="kt-portlet">
      ...
      <!--begin::Form-->
      <form class="kt-form kt-form--label-right" method="post" id="form_Mst_province" action="<?php echo site_url('ipkn_master_data/Mst_province/process')?>" enctype="multipart/form-data">
        <br>
        ...
        <div class="form-group row">
          <label class="col-form-label col-md-3">Nama Provinsi</label>
          <div class="col-md-4">
        ...
        <div class="kt-portlet__foot">
          <div class="kt-form__actions">
            <div class="row">
              ...
              <div class="col-10">
              <a onclick="getMenu('ipkn_master_data/Mst_province')" href="#" class="btn btn-sm btn-success">
