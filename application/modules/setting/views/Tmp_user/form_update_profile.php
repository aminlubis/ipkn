    ...
    $('#form_update_profile').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('<?php echo base_url()?>setting/Tmp_user/form_update_profile?_=' + (new Date()).getTime());
              ...
              <form class="form-horizontal" method="post" id="form_update_profile" action="<?php echo site_url('setting/Tmp_user/process_profile_user')?>" enctype="multipart/form-data">
                  ...
                  <?php if(isset($value->path_foto)) :?>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-4">
                          <img style="max-width:150px" class="editable img-responsive" alt="<?php echo $this->session->userdata('user')->fullname?>" id="avatar2" src="<?php echo base_url().PATH_PHOTO_PROFILE_DEFAULT.$value->path_foto?>" />
                        </div>
                      </div>
