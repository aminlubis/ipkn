    ...
    $('#form_Mst_subindex').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('<?php echo base_url()?>ipkn_master_data/Mst_subindex?_=' + (new Date()).getTime());
        }else{
          $.achtung({message: jsonResponse.message, timeout:5});
        }
        achtungHideLoader();
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="kt-portlet">
      ...
      <!--begin::Form-->
      <form class="kt-form kt-form--label-right" method="post" id="form_Mst_subindex" action="<?php echo site_url('ipkn_master_data/Mst_subindex/process')?>" enctype="multipart/form-data">
        <br>
        ...
        <div class="kt-portlet__foot">
          <div class="kt-form__actions">
            <div class="row">
              ...
              <div class="col-10">
              <a onclick="getMenu('ipkn_master_data/Mst_subindex')" href="#" class="btn btn-sm btn-success">
