...
class Tmp_mst_menu extends MX_Controller {
    ...
    public function get_data()
    {
        ...
        foreach ($list as $row_list) {
            ...
            // $row[] = '<div style="text-align: center">'.$row_list->menu_id.'</div>';
            $row[] = ucwords($row_list->name);
            $row[] = $row_list->modul_name;
            $row[] = ucfirst($row_list->class);
            $row[] = $row_list->link;
            // $row[] = '<div style="text-align: center">'.$row_list->level.'</div>';
            // $row[] = $row_list->icon;
            // $row[] = '<div style="text-align: center">'.$row_list->counter.'</div>';
