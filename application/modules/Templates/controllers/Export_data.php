...
class Export_data extends MX_Controller {
    ...
    //print_r($no_registrasi);die;
		switch ($type) {
			case 'pdf':
				$this->getContentPDF($no_registrasi, $flag, $pm, $act_code,$bagian,$no_kunjungan);
				break;
    ...
    public function getContentPDF($no_registrasi, $flag, $pm, $act_code='',$bagian,$no_kunjungan){
      ...
      $data = $reg_pm->get_hasil_pm($no_registrasi, $no_kunjungan, $bagian);
      /*get content html*/
