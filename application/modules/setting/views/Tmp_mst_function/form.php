    ...
    $('#form_Tmp_mst_function').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('<?php echo base_url()?>setting/Tmp_mst_function?_=' + (new Date()).getTime());
        }else{
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="kt-portlet">
      ...
      <!--begin::Form-->
      <form class="kt-form kt-form--label-right" method="post" id="form_Tmp_mst_function" action="<?php echo site_url('setting/Tmp_mst_function/process')?>" enctype="multipart/form-data">
        <br>
        ...
        <div class="form-group row">
          <label class="col-form-label col-md-3">Function Name</label>
          <div class="col-md-2">
          ...
          <label class="col-form-label col-md-1">Code</label>
          <div class="col-md-1">
