...
class Login_model extends CI_Model {
    ...
    public function get_hash_password($usr){
        ...
        $query = $this->db->select('tmp_user.*, tmp_user_profile.path_foto, mst_kl.kl_short_name, mst_kl.kl_name, mst_kl.kl_address, mst_kl.kl_email, mst_kl.kl_link_website, mst_kl.kl_icon')
                          ->select('(SELECT GROUP_CONCAT(tmp_mst_role.`role_id` SEPARATOR "/") AS role
                          ...
                          ->join('mst_kl','mst_kl.kl_id=tmp_user.kl_id','left')
