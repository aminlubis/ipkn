<center>
<div id="polar-spider" style="min-width: 400px; width: 100%; min-height: 800px; margin: 0 auto"></div>
<br>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $.getJSON('<?php echo base_url()?>Templates/Templates/graph?prefix=1&TypeChart=polar&style=2&mod=2', {id: 1, year: $('#year').val(), province: $('#province_id').val(), indicator: $('#indicator_id').val() }, function(chartData) {
