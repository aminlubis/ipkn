    ...
    $('#form_Tr_summary_dt').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('<?php echo base_url()?>data/Tr_summary_dt?_=' + (new Date()).getTime());
        }else{
          $.achtung({message: jsonResponse.message, timeout:5});
        }
        achtungHideLoader();
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="kt-portlet">
      ...
      <!--begin::Form-->
      <form class="kt-form kt-form--label-right" method="post" id="form_Tr_summary_dt" action="<?php echo site_url('data/Tr_summary_dt/process')?>" enctype="multipart/form-data">
        <br>

        <div class="form-group row">
          <label class="col-form-label col-md-3">ID</label>
          <div class="col-md-1">
            <input name="id" id="id" value="<?php echo isset($value)?$value->data_id:0?>" placeholder="Auto" class="form-control" type="text" readonly>
          </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-2">
            <?php echo $this->master->get_tahun(isset($value)?$value->year:'' , 'year', 'year', 'form-control', '', '') ?>
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="kt-portlet__foot">
          <div class="kt-form__actions">
            <div class="row">
              ...
              <div class="col-10">
              <a onclick="getMenu('data/Tr_summary_dt')" href="#" class="btn btn-sm btn-success">
