...
<html lang="en">
	...
	<head>
		<base href="../../">
		<meta charset="utf-8" />
		<title>TTDI - Dashboard System</title>
					...
					<div class="kt-aside__brand kt-grid__item" id="kt_aside_brand" style="width: 100%">
						<div class="kt-aside__brand-logo justify-content-center" style="text-align: center; width:90%">
							...
							<div style="padding-left: 10px; color: white !important">
								<div><span style="font-size: 35px;">TTDI</span></div>
								<div style="margin-top: -10px"><span>Dashboard</span></div>
							</div>
						</div>
					...
					<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
						<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
							...
							<ul class="kt-menu__nav ">
								<li class="kt-menu__item " aria-haspopup="true"><a href="<?php echo base_url().'dashboard'?>" class="kt-menu__link "><i class="kt-menu__link-icon flaticon-home"></i><span class="kt-menu__link-text">Dashboard</span></a></li>
							...
							<div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
								<ul class="kt-menu__nav ">
									<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel kt-menu__item--active" data-ktmenu-submenu-toggle="click" aria-haspopup="true">
										<marquee style="font-size: 14px">Selamat datang di Aplikasi Visualisasi & Integrasi TTDI (VISIT)</marquee>
									</span>
									</li>
								</ul>
							</div>
