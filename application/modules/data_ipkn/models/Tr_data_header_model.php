...
class Tr_data_header_model extends CI_Model {
	...
	var $table = 'ipkn_tr_data_header';
	var $column = array('ipkn_tr_data_header.dh_title','mst_provinces.name');
	var $select = 'ipkn_tr_data_header.*';

	var $order = array('ipkn_tr_data_header.dh_id' => 'DESC', 'ipkn_tr_data_header.updated_date' => 'DESC');
