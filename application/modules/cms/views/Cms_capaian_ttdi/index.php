...
<form class="kt-form kt-form--label-right" method="post" id="form_cms_capaian_ttdi" action="<?php echo site_url('cms/Cms_capaian_ttdi/process')?>" enctype="multipart/form-data">
  ...
  <div class="kt-portlet kt-portlet--mobile">
    ...
    <div class="kt-portlet__body">
      ...
      <!--begin: Datatable -->
      <table base-url="<?php echo base_url()?>cms/Cms_capaian_ttdi" class="table table-responsive-sm table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline">
        <thead>
